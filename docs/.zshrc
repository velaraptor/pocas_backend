...
plugins=(git docker dirhistory colorize docker-compose zsh-autosuggestions zsh-syntax-highlighting)
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir dir_writable_joined custom_git_pair vcs_joined)
...
POWERLEVEL9K_HOST_REMOTE_FOREGROUND='101'
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status ram os_icon time ssh)
